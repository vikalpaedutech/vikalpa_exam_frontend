...
{/* 
  ...
  (कक्षा 10वीं का परिणाम – हरियाणा सुपर 100 स्तर-2।)
            ...
            <hr></hr>  */}
             ...
             <Link  to="hs100-extended-100-result-l1" style={{textDecoration:'none', fontSize:'35px', color:'red'}}>
           <p>
  <BsArrowRight className="blinking-link" />
  Class 11th Result - Haryana Super 100 Level-2 Result (Extended 100 Seats). <br/>
  (कक्षा 11वीं का परिणाम – हरियाणा सुपर 100 लेवल-2 परिणाम (100 अतिरिक्त सीटें)।)
</p>
            </Link>
            <br /> 
            <hr></hr> 
...
{/* 
 ...
 {/* <Link  to="/exam-student-signin-sh" style={{textDecoration:'none', fontSize:'25px'}}>
            <p><BsArrowRight className="blinking-link" />Class 11th Registration - Haryana Super 100 (Extended 100 Seats) <br/>(
                 कक्षा 11वीं के लिए पंजीकरण - हरियाणा सुपर 100 योजना (100 अतिरिक्त सीटें)|)</p> 
            </Link>
            <br />  */}
