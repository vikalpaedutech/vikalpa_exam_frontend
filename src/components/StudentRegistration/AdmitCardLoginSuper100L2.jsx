...
export const AdmitCardStudentSigninSuper100Level2 = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res?.ok && res?.student) {
                ...
                if (student?.isPresentInL1Examination === false 
                ) {
...
//                         );
                        ...
                        navigate('/sh100-l1-result-notqualifed')
                        return;
                    }

                    if (student?.classOfStudent === "8") {
                        openModal(
                            "Please go to Mission Buniyaad Link to check your Mission Buinyaad Level 2 Result Status",
                    ...
                    if(student?.selectionStatusForL2 === "Selected" &&  student?.classOfStudent === "10" ){

                          // ✅ All good → navigate
                    navigate("/hs100-level1-result");
                    } else if (
                        student?.selectionStatusForL2 === "Waitinglist" &&  student?.classOfStudent === "10"
                    ) {
                    
                        navigate('/hs100-level1-waitinglist')
                    }
                    else {
                        navigate('/sh100-l1-result-notqualifed')
                    }
