...
export const MBL3OrientationDates = () => {
    ...
    const districts = [
        ...
        { sno: 7, name: "Yamunanagar", status: "Download Admit Card" },
        { sno: 8, name: "Charkhi Dadri", status: "Coming Soon" },
        { sno: 9, name: "Ambala", status: "Download Admit Card" },
        
        { sno: 10, name: "Palwal", status: "Download Admit Card" },
        { sno: 11, name: "Kaithal", status: "Download Admit Card" },
        { sno: 12, name: "Panipat", status: "Download Admit Card" },
        ...
        { sno: 16, name: "Rohtak", status: "Download Admit Card" },
        { sno: 17, name: "Fatehabad", status: "Download Admit Card" },
        { sno: 18, name: "Hisar", status: "Download Admit Card" },
        { sno: 19, name: "Jind", status: "Download Admit Card" },
