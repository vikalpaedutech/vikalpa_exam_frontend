...
export const WaitingListMBL3 = ({ singleStudent = null, bulkDownload = null, onDone = () => { } }) => {
    // contexts
    ...
    const formatDateToDDMMYYYY = (dateStr) => {
        ...
        return (
            ...
            {student.L1Qualified === true || student.L1Qualified === false ? (
                ...
                <Card className="shadow-sm" style={cardStyle}>
                    <Card.Header className="bg-white text-center border-0 py-2">
                        <div style={{ textAlign: "center" }}>
                            <div style={{ fontSize: 35, fontWeight: 700, color: "MediumSeaGreen" }}>Result Status - Waiting List
                          </div>
                        </div>
                    </Card.Header>
                    <hr></hr>
                    <Card.Body style={{ padding: "14px" }}>
                        ...
                        >
                            ...
                            You will be notified accordingly for counselling event.
                            <br /><br />
                            ...
                            <span style={{ fontWeight: "normal" }}>
                                (प्प्रिय {student.name}, हमें आपको यह सूचित करते हुए खुशी हो रही है कि आपको "वेटिंग लिस्ट" में रखा गया है। काउंसलिंग कार्यक्रम के लिए आपको समयानुसार सूचित किया जाएगा।)
                            </span>
                        </p>
