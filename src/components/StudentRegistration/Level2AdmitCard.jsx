...
// export const Level2AdmitCard = ({ singleStudent = null, bulkDownload = null, onDone = () => {} }) => {
//   // contexts
    ...
    const renderAdmitCardUI = (student) => {
        ...
        const downloadCertificate = async (student) => {
            try {
                ...
                // Template
                const templatePath = "/L1QualificationCertificateblank.png";
                ...
                doc.line(startX + 27, y + 1.5, startX + 77 + schoolWidth, y + 1.5);
                ...
                doc.setFont("times", "bold");
                doc.text(
                    "Mission Buniyaad Level 1 Entrance Examination for the batch 2026–28.",
                    startX + 39,
                    y,
                    { maxWidth: 220 }
                );
                ...
                // Save
                doc.save(`${name || "Student"}_Level1_Qualification_Certificate.pdf`);
        ...
        return (
            ...
            {student.L1Qualified === true ? (
                ...
                <Card className="shadow-sm" style={cardStyle}>
                    <Card.Header className="bg-white text-center border-0 py-2">
                        <div style={{ textAlign: "center" }}>
                            <div style={{ fontSize: 35, fontWeight: 700, color: "MediumSeaGreen" }}>You have Qualified Mission Buniyaad Entrance Examination Level-1!
                          </div>
                        </div>
                    </Card.Header>
                    <hr></hr>
                    <Card.Body style={{ padding: "14px" }}>
                        ...
                        >
                            Dear {student.name},
                            <br /><br />
                            We are pleased to inform you that you have successfully Qualified the Mission Buniyaad Entrance Examination Level 1{" "}
                            <strong>Mission Buniyaad Entrance Examination Level 1 for the 2026–28 batch.</strong> for the{" "}
                            <strong></strong>.
                            <br /><br />
                        
                            <strong>You may now download your Mission Buniyaad Examination Level 2 Admit Card and Mission Buniyaad Examination Level 1 Qualifying Certificate using the links provided below.</strong> and{" "}
                            
                            <br /><br />
                            <span style={{ fontWeight: "normal" }}>
                                (प्प्रिय {student.name}, हमें आपको यह सूचित करते हुए अत्यंत प्रसन्नता हो रही है कि आपने सत्र 2026–28 के लिए मिशन बुनियाद प्रवेश परीक्षा लेवल 1 सफलतापूर्वक उत्तीर्ण कर ली है। आप नीचे दिए गए लिंक के माध्यम से मिशन बुनियाद परीक्षा लेवल 2 का प्रवेश पत्र तथा मिशन बुनियाद परीक्षा लेवल 1 का उत्तीर्णता प्रमाण पत्र डाउनलोड कर सकते हैं।)
                            </span>
                        </p>
                        ...
                        <div className="d-flex align-items-center justify-content-center mb-3">
                            <div style={{ textAlign: "center" }}>
                                <a
                                    ...
                                    className="blinking-link"
                                >
                                    Download Mission Buniyaad Level-1 Qualification Certificate. <br />
                                    (मिशन बुनियाद लेवल-1 प्रमाण पत्र डाउनलोड करें)
                                </a>
                                <style>{`@keyframes blink { 0% { color: #d33; } 50% { color: #0b5fff; } 100% { color: #d33; } } .blinking-link { text-decoration: underline; }`}</style>
                            </div>
                        </div>
