...
export const MBDocVerificationCounselling = () => {
              ...
              <Accordion.Header>
                <div className="d-flex justify-content-between align-items-center w-100 me-3">
                  <span>
                    ...
                    MB Counselling - Document Verification
                  </span>
            ...
            <Card className="shadow-lg border-0 bg-gradient-search">
              <Card.Body className="p-5">
                <div className="text-center mb-4">
                  ...
                  <h3 className="mb-2">Student Document Verification</h3>
                  <p className="text-muted">Enter SRN to verify documents</p>
              ...
              <Card.Header className="bg-gradient-success text-white">
                <div className="d-flex justify-content-between align-items-center">
                  <h5 className="mb-0">
                    ...
                    Student Details & Document Verification
                  </h5>
                  ...
                  <Col md={12}>
                    <div className="student-info p-3" style={{ background: '#f8f9fa', borderRadius: '10px' }}>
                      <Row>
                        ...
                        <Col md={3} className="mt-2">
                          <strong>Selection Status:</strong> {currentStudent.selectionStatusForL3}
                        </Col>
                      </Row>
                    </div>
                  </Col>
                ...
                <Row>
                  <Col md={12}>
                    <h6 className="mb-3">
                      ...
                      <Badge bg="info" className="ms-2">Check all documents submitted by student</Badge>
                    </h6>
                    
                    <div className="documents-table p-3" style={{ background: '#fff', borderRadius: '10px', border: '1px solid #dee2e6' }}>
                      <div className="table-responsive">
                        <table className="table table-bordered">
                          <thead style={{ background: '#f8f9fa' }}>
                            <tr>
                              <th style={{ width: '1%' }}>#</th>
                              <th style={{ width: '10%' }}>Document Name (English)</th>
                          ...
                          <tbody>
                            <tr>
                              <td>1</td>
                              <td>Student's 3 Passport Size Photographs</td>
                         
                              <td className="text-center">
                                <Form.Check
                                  type="checkbox"
                                  checked={documents.student3PassportSizedPhoto}
                                  onChange={(e) => handleDocumentChange('student3PassportSizedPhoto', e.target.checked)}
                            ...
                            <tr>
                              <td>2</td>
                              <td>Student's Aadhar Card</td>
                              
                              <td className="text-center">
                                <Form.Check
                                  type="checkbox"
                                  checked={documents.studentAadharCardPhotoCopuy}
                                  onChange={(e) => handleDocumentChange('studentAadharCardPhotoCopuy', e.target.checked)}
                                  className="d-flex justify-content-center"
                                />
                              </td>
                            </tr>
                            <tr>
                              <td>3</td>
                              <td>Parent's Aadhar Card</td>
                           
                              <td className="text-center">
                                <Form.Check
                                  type="checkbox"
                                  checked={documents.parentsAaadhar}
                                  onChange={(e) => handleDocumentChange('parentsAaadhar', e.target.checked)}
                                  className="d-flex justify-content-center"
                                />
                              </td>
                            </tr>
                            <tr>
                              <td>4</td>
                              <td>Pre-counselling Form</td>
                    
                              <td className="text-center">
                                <Form.Check
                                  type="checkbox"
                                  checked={documents.preCounsellingForm}
                                  onChange={(e) => handleDocumentChange('preCounsellingForm', e.target.checked)}
                                  className="d-flex justify-content-center"
                                />
                              </td>
                            </tr>
                            <tr>
                              <td>5</td>
                              <td>Class 8 Marksheet (Photocopy)</td>
                       
                              <td className="text-center">
                                <Form.Check
                                  type="checkbox"
                                  checked={documents.class8MarksheetPhotoCopy}
                                  onChange={(e) => handleDocumentChange('class8MarksheetPhotoCopy', e.target.checked)}
                                  className="d-flex justify-content-center"
                                />
                              </td>
                            </tr>
                            <tr>
                              <td>6</td>
                              <td>Parivar Pehchan Patra (Photocopy)</td>
                         
                              <td className="text-center">
                                <Form.Check
                                  type="checkbox"
                                  checked={documents.pppPhotocopy}
                                  onChange={(e) => handleDocumentChange('pppPhotocopy', e.target.checked)}
                                  className="d-flex justify-content-center"
                                />
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td className="text-center">
                                <Form.Check
                                  type="checkbox"
                                  checked={documents.slc}
                                  onChange={(e) => handleDocumentChange('slc', e.target.checked)}
                                  className="d-flex justify-content-center"
                                />
                              </td>
                            </tr>
                    ...
                    {/* <div className="mt-3 p-3" style={{ background: '#e7f3ff', borderRadius: '10px', borderLeft: '4px solid #2196f3' }}>
                      <h6 className="mb-2">Admission Status Information:</h6>
                      <div className="mb-2">
                        <Badge bg="success" className="me-2">Selected</Badge>
                        <span>Students who are selected and submit SLC will get <strong>"Admission Done"</strong> status</span>
                      </div>
                      <div className="mb-2">
                        <Badge bg="warning" text="dark" className="me-2">Selected + No SLC</Badge>
                        <span>Students who are selected but haven't submitted SLC will get <strong>"Provisional"</strong> status</span>
                      </div>
                      <div>
                        <Badge bg="secondary" className="me-2">Waiting</Badge>
                        <span>Waiting students will remain in <strong>"Waiting"</strong> status regardless of documents</span>
                      </div>
                      <div className="mt-2">
                        <strong>Current Admission Status:</strong> {getAdmissionStatusBadge(currentStudent.finalAdmissionStatus)}
                      </div>
                      {documents.slc && currentStudent.selectionStatusForL3 === "Selected" && (
                        <div className="mt-2 text-success">
                          <i className="bi bi-check-circle-fill me-1"></i>
                          SLC submitted! Status will be updated to "Admission Done"
                        </div>
                      )}
                      {!documents.slc && currentStudent.selectionStatusForL3 === "Selected" && (
                        <div className="mt-2 text-warning">
                          <i className="bi bi-exclamation-triangle-fill me-1"></i>
                          SLC not submitted yet. Status will be "Provisional"
                        </div>
                      )}
                    </div> */}
                  </Col>
