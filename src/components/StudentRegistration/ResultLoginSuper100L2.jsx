...
export const ResultLoginSuper100L2 = () => {
...
//                         );
                        ...
                        navigate('/sh100-l2-result-notqualifed')
                        return;
                    }
                    ...
                    if(student?.finalShortListOrWaitListStudents === "Selected" &&  student?.classOfStudent === "10" ){

                          // ✅ All good → navigate
                    navigate("/hs100-level2-result");
                    } else if (
                        student?.finalShortListOrWaitListStudents === "Waitinglist" &&  student?.classOfStudent === "10"
                    ) {
                    
                        navigate('/hs100-level2-waitinglist')
                    }
                    else {
                        navigate('/')
                    }
