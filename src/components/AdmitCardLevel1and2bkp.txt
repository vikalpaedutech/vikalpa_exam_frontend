...
//  DownloadAdmitCard();
    async function DownloadAdmitCard () {
        ...
        if (admitcardLevelMB === "Level1"){
            ...
            pdf.text('Entrance Examination Level-3 (2025-27)', 105, 30, {align:'center'})
        }
        ...
        pdf.setFontSize(10);
        pdf.text(`Reporting Time: ${student.L3examReportingTime} , Exam Time: ${student.L3examTime}`, 105, 40, {align:"center"})
