...
//   // Function to calculate total block sums for Class 8 and Class 10
...
//                   {/* ABRC Schools Registration Table - Collapsible Accordion */}
//                   {lead.calledPersonRegion && lead.calledPersonRegion.length > 0 && (
//                     <Card className="mb-2">
//                       <Accordion>
//                         <Accordion.Item eventKey="0">
//                           <Accordion.Header>
//                             <strong>Click Here To See ABRC Schools Registration Summary</strong>
//                           </Accordion.Header>
...
export const AbrcCallings = () => {
  ...
  // Extract all blockIds from userAccess
  const getUserBlockIds = () => {
  ...
  const fetchCallLeads = async () => {
    ...
    setError(null);
    try {
      // Get all blockIds assigned to the user
      const blockIds = getUserBlockIds();
      
      if (blockIds.length === 0) {
        setError("No blocks assigned to this user");
        setLoading(false);
        return;
      }
