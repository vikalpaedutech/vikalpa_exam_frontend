...
//  const { districtBlockSchoolData, loadingDBS, dbsError, refetchDistrictBlockSchoolData } = useDistrictBlockSchool();
...
// import { Form, Container, Row, Col, Card, Button, Alert, Spinner } from "react-bootstrap";
// import { createOrUpdateUser } from "../../services/UserServices/UserService";
// import { useDistrictBlockSchool } from "../NewContextApis/District_block_schoolsCotextApi";
// import { getUserWithMobileAndPassword } from "../../services/UserServices/UserService";
...
//       <Card className="p-4 shadow-lg" style={{ width: "350px", borderRadius: "16px"}}>
//         <Card.Body>
//           <h3 className="text-center mb-4">OFFICIALS LOGIN</h3>
//           <hr></hr>
...
//     // For now: console.log the request body with _id as mobile (placeholder).
//     // You said you'll create controller later — so we send _id and password in body.
//     const reqBody = {
//       mobile: formData.mobile, // placeholder: using mobile as identifier until you wire actual _id
//       password: newPassword,
//     };

//     console.log("Forgot password - request body ->", reqBody);

//     // simulate success: reset forgot flow and show success message
//     setSuccessMsg("Password updated (simulated). You can now login with the new password.");
//     setForgotMode(false);
//     setOtpSent(false);
//     setGeneratedOtp("");
//     setEnteredOtp("");
          ...
          <Form onSubmit={handleSubmit}>
            ...
            {!forgotMode && (
              <>
                <Form.Group className="mb-3" controlId="formBasicMobile">
                  <Form.Label>Enter Your Registered Mobile Number:</Form.Label>
                  <small>(यदि आपने अपना मोबाइल नंबर अभी तक पंजीकृत नहीं किया है, तो "Create Account" पर क्लिक करके नंबर पंजीकृत करें।)</small>
                  <br></br>
                   <br></br>
                  <Form.Control
                    type="text"
