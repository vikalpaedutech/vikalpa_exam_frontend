...
//         link.setAttribute("download", `${schoolFilePart}_${selectedClass}_bulk_registration_template.csv`);
//         document.body.appendChild(link);
//         link.click();
//         document.body.removeChild(link);
//         URL.revokeObjectURL(url);
...
//                                 // cut to max 12 digits if longer
...
//         if (row.aadhar && !/^\d{12}$/.test(String(row.aadhar))) {
...
//                     formData.append("aadhar", onlyDigits(row.aadhar, 12));
//                     formData.append("mobile", trim(row.mobile));
//                     formData.append("whatsapp", trim(row.whatsapp));
//                     formData.append("registrationDate", registrationDate);
//                     formData.append("isRegisteredBy", userData.user._id); // Use actual user ID
...
//                 if (h === "aadhar") {
//                     const digits = onlyDigits(r.data?.[h] ?? "", 12);
