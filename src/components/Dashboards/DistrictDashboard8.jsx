...
export const Districtdashboard8 = () => {
  ...
  const buildDistrictsAndBlocksFromMainData = () => {
    ...
    for (const school of mainDashboardData) {
      ...
      districtsMap[districtId].totalRegistered += reg8;
      districtsMap[districtId].totalAdmitCard += admitCard8;
      ...
      districtsMap[districtId].blocks[blockId].registered += reg8;
      districtsMap[districtId].blocks[blockId].admitCard += admitCard8;
    }
